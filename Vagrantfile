...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "manikdham-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/pearson_adhamma"
  #   chef.validation_client_name = "pearson_adhamma-validator"
  #   chef.validation_key_path = ".chef/pearson_adhamma-validator.pem"
  # end
end
